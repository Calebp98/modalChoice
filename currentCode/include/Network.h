...
template<typename V>
class ModelCustomEdge : public repast::RepastEdge<V>{ //what does the colon on this line do
private:
    int confidence; //how strong the relationship on this edge is
 //don't understand most of this, will clarify later
public:
    ModelCustomEdge(){}
